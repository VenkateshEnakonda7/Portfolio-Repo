...
const About = () => {
  const skills = [
    "Selenium WebDriver", "Appium", "TestNG", "JUnit", "Python", "Java",
    "JavaScript", "REST API Testing", "Postman", "Jenkins", "Docker", 
    "Git/GitHub", "JIRA", "CI/CD", "Agile", "BDD", "Cucumber"
  ];
          ...
          <div className="space-y-8">
            <div className="glass-card p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                With over 6 years of experience in software testing and automation, I specialize in 
                creating robust, scalable test frameworks that integrate seamlessly with modern 
                development workflows. My expertise spans web, mobile, and API testing automation.
              </p>
